...
var buildFileTag = build_file_tag_string_1.buildFileTagString;
 ...
 */
var verifyConfig = function (config, next) {
...
var logFactory = function (config) {
    ...
    return verifyConfig(config, function (conf) { return function buildLog(fileName, opts) {
        if (opts === void 0) { opts = defLogOpts; }
        var logLevelNum = getLogVal(conf.logLevel);
...
var simple_by_log_level_1 = require("./src/simple-by-log-level");
exports.isolog = simple_by_log_level_1.isolog;
