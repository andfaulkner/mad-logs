 ...
 */
export declare const logFactory: (filename: string, style?: ((fName: string) => string) | ((fName: string) => string[]) | "none" | "aquarium" | "angryBird" | "arrow" | "backAndForth" | "bracelet" | "cult" | "escherBarbieLego" | "hatBlock" | "joy" | "lucky" | "maceWindu" | "probeArcade" | "potOfGold" | "rainbowLeaf" | "rockIsDead" | "smokeyHatesChristmas" | "theHeist", inspector?: Function) => Log & ((...args: any[]) => void) & {
