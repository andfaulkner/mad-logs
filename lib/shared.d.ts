 ...
 */
export declare const logFactory: (filename: string, style?: ((fName: string) => string) | ((fName: string) => string[]) | "none" | "angryBird" | "aquarium" | "arrow" | "backAndForth" | "bracelet" | "cult" | "escherBarbieLego" | "hatBlock" | "joy" | "lucky" | "maceWindu" | "mechanicalAtFists" | "moProblems" | "mrsPotatoVHS" | "nightmare" | "pipeDream" | "potOfGold" | "probeArcade" | "rainbowLeaf" | "rockIsDead" | "smokeyHatesChristmas" | "springy" | "swimmers" | "tangerines" | "theBird" | "theHeist" | "vendetta" | "zebra", inspector?: Function) => Log & ((...args: any[]) => void) & {
