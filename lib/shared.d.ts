 ...
 */
export declare const logFactory: (filename: string, style?: ((fName: string) => string) | ((fName: string) => string[]) | "a" | "aquarium" | "b" | "rainbowLeaf" | "c" | "lucky" | "d" | "probeArcade" | "e" | "potOfGold" | "f" | "cult" | "g" | "bracelet" | "h" | "rockIsDead" | "i" | "smokeyHatesChristmas" | "j" | "joy" | "k" | "hatBlock" | "l" | "theHeist", inspector?: Function) => Log & ((...args: any[]) => void) & {
