...
var cantTouch = isNode
    ...
    : function (fName) { return [
        buildFileTagForBrowser(fName, theming_1.madLogMarkers.cantTouch),
        theming_1.madLogMarkers.cantTouch.style,
    ]; };
var cartoonSwearing = isNode
    ? function (fName) { return underline(bgCyan(red("@%@%! [" + fName + "] !@%@%"))) + ' '; }
    : function (fName) { return [
        buildFileTagForBrowser(fName, theming_1.madLogMarkers.cartoonSwearing),
...
var fresh = isNode
    ...
    : function (fName) { return [
        buildFileTagForBrowser(fName, theming_1.madLogMarkers.fresh),
...
var neverEnough = isNode
    ...
    : function (fName) { return [
        buildFileTagForBrowser(fName, theming_1.madLogMarkers.neverEnough),
...
var ohMy = isNode
    ? function (fName) { return black(bgGreen("\uD83E\uDD81 \uD83D\uDC2F \uD83D\uDC3B  " + fName + " \uD83D\uDC3B \uD83D\uDC2F \uD83E\uDD81 ")) + ' '; }
    : function (fName) { return [
        buildFileTagForBrowser(fName, theming_1.madLogMarkers.ohMy),
...
var seafoamSalad = isNode
    ? function (fName) { return bold(white(bgGreen("\uD83C\uDF53  " + fName + " \uD83C\uDF45 "))) + ' '; }
    : function (fName) { return [
        buildFileTagForBrowser(fName, theming_1.madLogMarkers.seafoamSalad),
...
var xmlHell = isNode
    ? function (fName) { return underline(bold(white(bgBlack("<<< " + fName + " >>>")))) + ' '; }
    : function (fName) { return [
        buildFileTagForBrowser(fName, theming_1.madLogMarkers.xmlHell),
