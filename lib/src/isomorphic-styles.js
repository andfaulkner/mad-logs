...
var arrow = isNode
    ...
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.arrow),
...
var cult = isNode
    ...
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.cult),
...
var fresh = isNode
    ...
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.fresh),
        theming_1.madLogMarkers.fresh.style,
    ]; };
...
var joy = isNode
    ? function (fName) { return bgYellow(black("\uD83D\uDE00 \uD83D\uDE00 [" + fName + "]\uD83D\uDE00 \uD83D\uDE00 ")) + ' '; }
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.joy),
...
var lucky = isNode
    ? function (fName) { return bold(white(bgGreen("\uD83C\uDF40 [" + fName + "]\uD83C\uDF40 "))) + ' '; }
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.lucky),
...
var ohMy = isNode
    ? function (fName) { return black(bgGreen("\uD83E\uDD81 \uD83D\uDC2F \uD83D\uDC3B  " + fName + " \uD83D\uDC3B \uD83D\uDC2F \uD83E\uDD81 ")) + ' '; }
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.ohMy),
        theming_1.madLogMarkers.ohMy.style,
    ]; };
...
var springy = isNode
    ...
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.springy),
...
var theBird = isNode
    ...
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.theBird),
...
var xmlHell = isNode
    ? function (fName) { return underline(bold(white(bgBlack("<<< " + fName + " >>>")))) + ' '; }
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.xmlHell),
        theming_1.madLogMarkers.xmlHell.style,
    ]; };
var zebra = isNode
    ? function (fName) { return underline(bold(white(bgBlack("| | | " + fName + " | | |")))) + ' '; }
    : function (fName) { return [
        buildFileTag(fName, theming_1.madLogMarkers.zebra),
