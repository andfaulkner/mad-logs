...
exports.madLogMarkers = {
    ...
    pipeDream: {
        tagPrefix: '┣╋━╋~🛀~╋━╋┫',
        tagSuffix: '┣┫',
        style: "color: " + exports.colours.gray + "; background-color: " + exports.colours.blue + ";",
    },
    swimmers: {
        tagPrefix: '~~~~@ ',
        tagSuffix: '',
    ...
    theHeist: {
        ...
        style: (detect_node_1.default) ? "" + isomorphic_styles_1.isomorphicStyles.black + isomorphic_styles_1.isomorphicStyles.bold + isomorphic_styles_1.isomorphicStyles.bgWhite
            : exports.colours.black + "; " + exports.style.underline + "; " + exports.style.bold + "; " +
                ("background-color: " + exports.colours.black + ";")
    },
    vendetta: {
        tagPrefix: "/~~VVV~~|| ",
        tagSuffix: ' ||~~VVV~~\\',
