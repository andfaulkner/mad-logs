...
exports.madLogMarkers = {
    ...
    backAndForth: {
        ...
        tagSuffix: '))><((',
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.black + isomorphic_styling_1.isoStyling.bold + isomorphic_styling_1.isoStyling.underline
            : "color: " + colours.brown + "; " + exports.style.bold + " " + exports.style.underline,
    },
    barbells: {
        tagPrefix: '()-()--',
        tagSuffix: '--()-()',
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.gray + isomorphic_styling_1.isoStyling.bgWhite + isomorphic_styling_1.isoStyling.bold
            : "color: " + colours.darkGray + "; " + exports.style.bold,
    },
    bracelet: {
        tagPrefix: '🔮🔮🔮',
        tagSuffix: '🔮🔮🔮',
    ...
    grasslands: {
        ...
        tagSuffix: '^^^^',
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.bgWhite + isomorphic_styling_1.isoStyling.magenta
            : "color: " + colours.green + "; " + exports.style.bold,
    },
    hatBlock: {
        tagPrefix: '😀⛑👒🎩🎓👑',
        tagSuffix: '👑🎓🎩👒⛑',
    ...
    lispyKatana: {
        ...
        tagSuffix: ';;;;;;;;;;;;;;()()',
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.blue + isomorphic_styling_1.isoStyling.bold + isomorphic_styling_1.isoStyling.bgWhite
            : "color: " + colours.gray + "; " + exports.style.bold,
    },
    lucky: {
        tagPrefix: '🍀🍀🍀',
        tagSuffix: '🍀🍀🍀',
    ...
    maceWindu: {
        ...
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.white + isomorphic_styling_1.isoStyling.bgBlack
            : "color: " + colours.violet + "; " + exports.style.bold,
    },
    mechanicalAtFists: {
        tagPrefix: '--#@!@#--',
        tagSuffix: ' || ',
    ...
    moProblems: {
        ...
        tagSuffix: ' |💰| $$$$$$$',
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.white + isomorphic_styling_1.isoStyling.bgBlack
            : "color: " + colours.gold + "; " + exports.style.bold,
    },
    mrsPotatoVHS: {
        tagPrefix: '(👃👁👂)',
        tagSuffix: '(👂👁👅)',
    ...
    pipeDream: {
        ...
        tagSuffix: ' ┣┫',
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.white + isomorphic_styling_1.isoStyling.bgBlack
            : "color: " + colours.gray + "; background-color: " + colours.white + "; " + exports.style.bold,
    },
    potOfGold: {
        tagPrefix: ' 💰 ',
        tagSuffix: ' 💰 ',
    ...
    smokeyHatesChristmas: {
        ...
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.green + isomorphic_styling_1.isoStyling.bold + isomorphic_styling_1.isoStyling.bgWhite
            : "color: " + colours.orange + "; " + exports.style.underline + "; " + exports.style.bold,
    },
    springy: {
        tagPrefix: '◀-\\__/--',
        tagSuffix: '--\\__/-►',
    ...
    theHeist: {
        ...
        tagSuffix: "_|😎🔧🔒|📦",
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.black + isomorphic_styling_1.isoStyling.bold + isomorphic_styling_1.isoStyling.bgWhite
            : "color: " + colours.white + "; " + exports.style.underline + "; " +
                ("background-color: " + colours.darkGray + "; " + exports.style.bold)
    },
    vendetta: {
        tagPrefix: "/~~VVV~~|| ",
        tagSuffix: ' ||~~VVV~~\\',
        style: detect_node_1.default ? "" + isomorphic_styling_1.isoStyling.black + isomorphic_styling_1.isoStyling.bold + isomorphic_styling_1.isoStyling.bgWhite
            : "color: " + colours.deepRed + "; " +
                (exports.style.bold + " background-color: " + colours.ultraPaleGreen),
    },
    xmlHell: {
        tagPrefix: '<<<<<>>>>>',
        tagSuffix: ' >> ',
