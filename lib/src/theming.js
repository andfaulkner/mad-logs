...
exports.madLogMarkers = {
    ...
    pipeDream: {
        ...
        style: (detect_node_1.default) ? "" + isomorphic_styles_1.isomorphicStyles.white + isomorphic_styles_1.isomorphicStyles.bgBlack
            : "color: " + exports.colours.gray + "; background-color: " + exports.colours.blue + ";",
    },
    rockIsDead: {
        tagPrefix: '💀☠🎸💀💎💀🎸💀 |',
        tagSuffix: '| 😃🔊♪♪💃💃💃💃💃🎧😃',
        style: (detect_node_1.default) ? "" + isomorphic_styles_1.isomorphicStyles.yellow + isomorphic_styles_1.isomorphicStyles.bold + isomorphic_styles_1.isomorphicStyles.bgBlack
            : "color: " + exports.colours.yellow + "; background-color: " + exports.colours.black + ";",
    },
    swimmers: {
        tagPrefix: '~~~~@ ',
        tagSuffix: '',
    ...
    theHeist: {
        ...
        style: (detect_node_1.default) ? "" + isomorphic_styles_1.isomorphicStyles.black + isomorphic_styles_1.isomorphicStyles.bold + isomorphic_styles_1.isomorphicStyles.bgWhite
            : "color: " + exports.colours.white + "; " + exports.style.underline + "; " +
                ("background-color: " + exports.colours.black + "; " + exports.style.bold + ";")
    },
    vendetta: {
        tagPrefix: "/~~VVV~~|| ",
        tagSuffix: ' ||~~VVV~~\\',
