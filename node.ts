...
export const inspect = (obj: RealAny, isHidden?: boolean): string => {
    const depth = (() => {
        let logLevelNorm =
            process.env.LOG_LEVEL && typeof process.env.LOG_LEVEL === 'string'
 ...
 * deep-inspected versions of objects, and automatically logging them with
 * IDing information if (by default) LOG_LEVEL is silly, verbose, debug or info
 *
